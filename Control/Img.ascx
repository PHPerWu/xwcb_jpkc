<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Img.ascx.cs" Inherits="myImgTxt" %>
...
<Itemtemplate>
    ...
    <a  href="view.aspx?CID=<%#Eval("CID")%>"target="_blank"><img src="style/<%#Eval("CPIC")%>" width="115" height="152"></a>
</Itemtemplate>
</asp:Repeater>
