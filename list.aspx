  ...
  <tbody><tr> 
    <td width="75%" height="393" valign="top" class="Main"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="guide">
        <tbody><tr> 
          <td><a href="http://xcy.hubu.edu.cn/jpkc/xz" class="guide_menu">&gt;首页</a> -&gt; <a href="list.aspx?CatNameID=<%=Convert.ToInt16(Request.QueryString["CatNameID"].ToString()) %>" class="guide_menu">
